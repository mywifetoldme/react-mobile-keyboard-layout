 ...
 *
 *  1. publish the keyboard height (`--rmkl-v20-kb`) and the covered inset (`--rmkl-v20-kb-inset`)
...
export const KEYBOARD_HEIGHT_CSS_VAR = '--rmkl-v20-kb'
...
export const KEYBOARD_INSET_CSS_VAR = '--rmkl-v20-kb-inset'
