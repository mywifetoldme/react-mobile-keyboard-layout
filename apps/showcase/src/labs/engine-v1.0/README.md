...
렌더하고, 파인딩이 패키지에 들어갈 때마다 사본을 다시 떴습니다). 여섯 번째 실기기 라운드로 완결된 `691410d`에서 얼렸습니다.

## 출처

- 커밋: `691410d` (v1.0.0 + PR #23: `PageLayout`, `FloatingInput` pointerup 포커스, `useMobileKeyboard` 수정들)
...
for p in components/SubpageLayout.tsx components/SubpageLayout.css \
  ...
  git show "691410d:packages/react-mobile-keyboard-layout/src/$p" \
