...
export const FloatingInput = ({
  ...
  return (
    <div
      ...
      className={`rmkl-v02-floating-input-wrapper${isKeyboardOpen ? ' rmkl-v02-floating-input-wrapper--keyboard-open' : ''}${isSuppressed ? ' rmkl-v02-floating-input-wrapper--suppressed' : ''} ${className}`.trim()}
      style={{
        ...style,
        ...suppressedStyle,
      }}
    >
      <div className="rmkl-v02-floating-input-bar">
        <textarea
          ref={textareaRef}
          rows={1}
          maxLength={2000}
          ...
          {...restTextareaProps}
          className={`rmkl-v02-floating-input-textarea ${textareaClassName}`.trim()}
          style={textareaStyle}
          value={value}
        ...
        <button
          ...
          disabled={!canSubmit}
          {...restButtonProps}
          className={`rmkl-v02-floating-input-send${canSubmit ? ' rmkl-v02-floating-input-send--active' : ''} ${buttonClassName}`.trim()}
          style={buttonStyle}
          onClick={(e) => {
